...
export default function AIRecruitingProduct() {
            ...
            <Stack mx={0.5} spacing={1}>
              ...
              >
                <Box fontSize="50px" mr={2}>
                  <PersonPinTwoTone fontSize="inherit" color="secondary" />
                </Box>
                <Box flexGrow={1}>
                  ...
                  <Typography variant="body2" gutterBottom>
                    HR will use the software to automate repetitive tasks in
                    order to become more efficient, automate candidate
                    assessment and remove human bias, coaching...
                  </Typography>
                  <Button
                    endIcon={<Launch />}
                    size="small"
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Item>
                        HR will use the software to automate repetitive tasks in
                        order to become more efficient, automate candidate
                        assessment and remove human bias, coaching and engaging
                        employees to enable personal growth.
                      </Item>
                      <Divider />
                      <Item>
                        <Typography
