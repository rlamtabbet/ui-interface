...
import AddModels from "./tasks/add-models";
...
export default function Inbox() {
  ...
  return (
    ...
    >
      ...
      >
        <Item p={3}>
          <Route exact path="/inbox/task-define" component={Define} />
          <Route exact path="/inbox/task-add-models" component={AddModels} />
          <Route exact path="/inbox/task-alignment" component={Alignment} />
          <Route exact path="/inbox/task-finalize" component={Finalize} />
          <Route exact path="/inbox/task-assessment" component={Assessment} />
          <Route exact path="/inbox/task-policy" component={Policy} />
          <Route exact path="/inbox/task-report" component={Report} />
        </Item>
      </Grid>
    </Grid>
  );
